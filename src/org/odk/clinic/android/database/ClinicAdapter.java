...
public class ClinicAdapter {
	...
	private static final String CREATE_COHORTS_TABLE = "create table "
		...
		+ KEY_COHORT_ID + " integer not null, " 
		+ KEY_NAME + " text);";
     ...
     */
	/*
    private String generateDisplay(String path) {
        ...
        return "Patient (" + p.split(filename)[0] + ")";
    }*/
	...
	public boolean deleteForm(Integer formId) {
	    return mDb.delete(FORMS_TABLE, KEY_FORM_ID + "=" + formId, null) > 0;
	}
    ...
    public Cursor fetchForm(Integer formId) throws SQLException {
        Cursor c = null;
        c = mDb.query(true, FORMS_TABLE, new String[] { KEY_ID, KEY_NAME, KEY_PATH },
    ...
    public Cursor fetchFormInstance(Integer patientId, Integer formId) throws SQLException {
        ...
        c = mDb.query(true, FORMINSTANCES_TABLE, new String[] { KEY_ID,
                KEY_FORMINSTANCE_STATUS, KEY_PATH, KEY_FORMINSTANCE_DISPLAY},
                KEY_PATIENT_ID + "=" + patientId + " AND " + KEY_FORM_ID
    ...
    public Cursor fetchPatientFormInstancesByStatus(Integer patientId, Integer formId, String status) throws SQLException {
        Cursor c = null;
        c = mDb.query(true, FORMINSTANCES_TABLE, new String[] { KEY_ID, KEY_FORMINSTANCE_STATUS, KEY_PATH, KEY_FORMINSTANCE_DISPLAY},
                KEY_PATIENT_ID + "=" + patientId + " AND " + KEY_FORM_ID
                        + "=" + formId + " AND " + KEY_FORMINSTANCE_STATUS + "='" + status + "'"
    ...
    public Cursor fetchFormInstances(Integer patientId) throws SQLException {
        Cursor c = null;
        c = mDb.query(true, FORMINSTANCES_TABLE, new String[] { KEY_ID,
                KEY_FORM_ID, KEY_FORMINSTANCE_STATUS, KEY_PATH, KEY_FORMINSTANCE_DISPLAY},
                KEY_PATIENT_ID + "=" + patientId, null, null, null, null, null);
    ...
    public Cursor fetchFormInstance(long id) throws SQLException {
        Cursor c = mDb.query(true, FORMINSTANCES_TABLE, new String[] {
                KEY_ID, KEY_FORM_ID, KEY_FORMINSTANCE_STATUS, KEY_PATH, KEY_FORMINSTANCE_DISPLAY
    ...
    public Cursor fetchFormInstancesByStatus(String	status) throws SQLException {
        Cursor c = null;
        c = mDb.query(true, FORMINSTANCES_TABLE, new String[] { KEY_ID,
                KEY_PATIENT_ID, KEY_PATH, KEY_FORM_ID, KEY_FORMINSTANCE_DISPLAY, KEY_FORMINSTANCE_STATUS},
    ...
    public Cursor fetchFormInstancesByPath(String path) throws SQLException {
        ...
        c = mDb.query(true, FORMINSTANCES_TABLE, new String[] { KEY_ID,
                KEY_FORM_ID, KEY_FORMINSTANCE_STATUS, KEY_PATH, KEY_FORMINSTANCE_DISPLAY},
                KEY_PATH + "='" + path +"'", null, null, null, null, null);
    ...
    public boolean updateFormName(Integer formId, String formName) {
        ContentValues cv = new ContentValues();

        cv.put(KEY_FORM_ID, formId);
        cv.put(KEY_NAME, formName);
